      ...
      <div>
        ...
        <div className='row'>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="current_pincode" placeholder="Enter country" onChange={handleChange} value={user?.current_pincode} />
        ...
        <div className='row'>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>Pincode</Form.Label>
              <Form.Control type="text" name="parmanent_pincode" placeholder="Enter country" onChange={handleChange} value={user?.parmanent_pincode} />
