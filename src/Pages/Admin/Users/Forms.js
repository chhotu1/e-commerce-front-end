      ...
      <div>
        <div className='row'>
         ...
         <div className='col-md-6'>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="phone" placeholder="Enter phone" onChange={handleChange}  value={user?.phone?user?.phone:''} maxLength={10} onKeyPress={isNumber} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>Monthly salary</Form.Label><Form.Label className='error'>*</Form.Label>
              <Form.Control type="text" name="monthly_salary" placeholder="Enter monthly salary" onChange={handleChange}  value={user?.monthly_salary?user?.monthly_salary:''} maxLength={6} onKeyPress={isNumber} />
         ...
         <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Select designation" name="designation" onChange={handleChange} value={user?.designation?user?.designation:''}>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="date" name="date_of_birth" max={this.state.max_date} placeholder="Enter date_of_birth" onChange={handleChange} value={user?.date_of_birth?user?.date_of_birth:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="experience" placeholder="Enter experience" onChange={handleChange} value={user?.experience?user?.experience:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="specialist" placeholder="Enter specialist" onChange={handleChange} value={user?.specialist?user?.specialist:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="adhar_no" placeholder="Enter adhar_no" onChange={handleChange} value={user?.adhar_no?user?.adhar_no:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="pain_no" placeholder="Enter pain_no" onChange={handleChange} value={user?.pain_no?user?.pain_no:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="father_mobile_no" maxLength={10} onKeyPress={isNumber} placeholder="Enter father_mobile_no" onChange={handleChange} value={user?.father_mobile_no?user?.father_mobile_no:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="other_phone" maxLength={10} onKeyPress={isNumber} placeholder="Enter other_phone" onChange={handleChange} value={user?.other_phone?user?.other_phone:''} />
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="friend_phone" maxLength={10} onKeyPress={isNumber} placeholder="Enter friend_phone" onChange={handleChange} value={user?.friend_phone?user?.friend_phone:''} />
        ...
        <div className='row'>
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Select role" name="current_country" onChange={handleChange} value={user?.current_country?user?.current_country:''}>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Select state" name="current_state" onChange={handleChange} value={user?.current_state?user?.current_state:''}>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Select city" name="current_city" onChange={handleChange} value={user?.current_city?user?.current_city:''}>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="current_pincode" maxLength={7} placeholder="Enter country" onChange={handleChange} value={user?.current_pincode?user?.current_pincode:''} />
          ...
          <div className='col-md-12'>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="current_address" placeholder="Enter formated address" onChange={handleChange} value={user?.current_address?user?.current_address:''} />
        ...
        <div className='row'>
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>Country</Form.Label>
              <Form.Select aria-label="Select country" name="parmanent_country" onChange={handleChange} value={user?.parmanent_country?user?.parmanent_country:''}>
                <option>Select Country</option>
                {Countries && Countries.map((item, index) => {
                  return (
                    <option value={item.id} key={index}>{item.name}</option>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>State</Form.Label>
              <Form.Select aria-label="Select state" name="parmanent_state" onChange={handleChange} value={user?.parmanent_state?user?.parmanent_state:''}>
                <option>Select state</option>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>City</Form.Label>
              <Form.Select aria-label="Select city" name="parmanent_city" onChange={handleChange} value={user?.parmanent_city?user?.parmanent_city:''}>
                <option>Select city</option>
          ...
          <div className='col-md-6'>
            <Form.Group className="mb-3">
              <Form.Label>Pincode</Form.Label>
              <Form.Control type="text" name="parmanent_pincode" maxLength={7} placeholder="Enter country" onChange={handleChange} value={user?.parmanent_pincode?user?.parmanent_pincode:''} />
          ...
          <div className='col-md-12'>
            <Form.Group className="mb-3">
              <Form.Label>Full address</Form.Label>
              <Form.Control type="text" name="parmanent_address" placeholder="Enter formated address" onChange={handleChange} value={user?.parmanent_address?user?.parmanent_address:''} />
